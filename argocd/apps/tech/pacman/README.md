...
`argocd/apps/tech/` committet und gepusht ist, entdeckt das
...
Das `kaniko-build-push`-Argo-WorkflowTemplate (`argocd/apps/tech/argo-workflows/`)
...
- Die Zugriffslogs (inkl. IP/GeoIP bei aktivierter Anreicherung) landen im
  zentralen Logging-Stack (`argocd/apps/tech/logging/`,
