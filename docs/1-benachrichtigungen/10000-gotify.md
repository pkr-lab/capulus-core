...
(`argocd/apps/tech/gotify/`). Der Android/iOS-Gotify-Client (oder einer der
...
`argocd/apps/tech/gotify/values.yaml` öffnen und den Platzhalter ersetzen:
...
```bash
git add argocd/apps/tech/gotify/values.yaml
