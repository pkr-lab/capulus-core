...
Liegt unter `argocd/apps/tech/alamos-apager/`, wird wie jede andere App in
...
2. SealedSecret erzeugen/aktualisieren (ein Key pro Standort, Key-Name =
   ...
   kubectl create secret generic alamos-apager-stations \
     ...
     > argocd/apps/tech/alamos-apager/templates/sealedsecret-stations.yaml
   git add argocd/apps/tech/alamos-apager/templates/sealedsecret-stations.yaml
