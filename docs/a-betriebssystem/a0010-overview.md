...
| 30080 | TCP | ArgoCD-API/CLI/CI (Klartext-HTTP; die Web-UI läuft per HTTPS über Traefik: `argocd.tech.homeserver`) | LAN + Tailnet |
...
443, 631, 6443 und 30080 nur im LAN und im Tailnet, nach außen nur 41641/UDP.
