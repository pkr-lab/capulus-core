...
```
192.168.178.94  semaphore.tech.homeserver grafana.tech.homeserver headlamp.tech.homeserver
```
...
Seit `argocd/apps/tech/pihole/` existiert, leitet dnsmasq alle nicht-`*.homeserver`-
