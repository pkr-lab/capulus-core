...
| Modify | `Makefile` |
| Create | `argocd/apps/tech/monitoring/ugreen-nas-scrape.yaml` |
...
Erstelle `argocd/apps/tech/monitoring/ugreen-nas-scrape.yaml`:
...
```bash
yamllint -c .yamllint argocd/apps/tech/monitoring/ugreen-nas-scrape.yaml
```
...
```bash
git add argocd/apps/tech/monitoring/ugreen-nas-scrape.yaml
