...
- `gotify` — Instanz läuft bereits als k8s-App im Cluster (`argocd/apps/tech/gotify`)
...
Im Cluster wird `argocd/apps/tech/monitoring/` um einen `VMStaticScrape` erweitert,
